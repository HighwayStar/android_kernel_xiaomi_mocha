...
static struct tegra12_emc_table mocha_samsung_3gb_derated[] = {
	{
		0x19,       /* V5.0.16 */
		"1_12750_02_V5.0.16_V1.1", /* DVFS table version */
	...
	{
		0x19,       /* V5.0.16 */
		"1_20400_02_V5.0.16_V1.1", /* DVFS table version */
	...
	{
		0x19,       /* V5.0.16 */
		"1_40800_02_V5.0.16_V1.1", /* DVFS table version */
	...
	{
		0x19,       /* V5.0.16 */
		"1_68000_02_V5.0.16_V1.1", /* DVFS table version */
	...
	{
		0x19,       /* V5.0.16 */
		"1_102000_02_V5.0.16_V1.1", /* DVFS table version */
	...
	{
		0x19,       /* V5.0.16 */
		"1_204000_02_V5.0.16_V1.1", /* DVFS table version */
		...
		31,         /* number of up_down_regs */
		{
			...
			0x00000000, /* EMC_DLL_XFORM_QUSE6 */
			0x00000000, /* EMC_DLL_XFORM_QUSE7 */
			0x000a8000, /* EMC_DLL_XFORM_ADDR0 */
			0x000a8000, /* EMC_DLL_XFORM_ADDR1 */
			0x00000000, /* EMC_DLL_XFORM_ADDR2 */
			0x000a8000, /* EMC_DLL_XFORM_ADDR3 */
			0x000a8000, /* EMC_DLL_XFORM_ADDR4 */
			0x00000000, /* EMC_DLL_XFORM_ADDR5 */
			0x00000000, /* EMC_DLL_XFORM_QUSE8 */
			0x00000000, /* EMC_DLL_XFORM_QUSE9 */
			0x00000000, /* EMC_DLL_XFORM_QUSE10 */
	...
	{
		0x19,       /* V5.0.16 */
		"1_300000_02_V5.0.16_V1.1", /* DVFS table version */
		...
		31,         /* number of up_down_regs */
		{
			...
			0x00005800, /* EMC_DLL_XFORM_DQ5 */
			0x00005c00, /* EMC_DLL_XFORM_DQ6 */
			0x00005800, /* EMC_DLL_XFORM_DQ7 */
			0x00000200, /* EMC_XM2CMDPADCTRL */
			0x00000000, /* EMC_XM2CMDPADCTRL4 */
			0x00100100, /* EMC_XM2CMDPADCTRL5 */
	...
	{
		0x19,       /* V5.0.16 */
		"1_396000_02_V5.0.16_V1.1", /* DVFS table version */
	...
	{
		0x19,       /* V5.0.16 */
		"1_528000_02_V5.0.16_V1.1", /* DVFS table version */
		...
		31,         /* number of up_down_regs */
		{
			...
			0x00000000, /* EMC_DLL_XFORM_QUSE14 */
			0x00000000, /* EMC_DLL_XFORM_QUSE15 */
			0x00000001, /* EMC_DLI_TRIM_TXDQS0 */
			...
			0x00000000, /* EMC_DLI_TRIM_TXDQS7 */
			0x00000001, /* EMC_DLI_TRIM_TXDQS8 */
	...
	{
		0x19,       /* V5.0.16 */
		"1_600000_02_V5.0.16_V1.1", /* DVFS table version */
		...
		31,         /* number of up_down_regs */
		{
			...
			0x00000000, /* EMC_DLL_XFORM_QUSE14 */
			0x00000000, /* EMC_DLL_XFORM_QUSE15 */
			0x00000003, /* EMC_DLI_TRIM_TXDQS0 */
			0x00000003, /* EMC_DLI_TRIM_TXDQS1 */
			0x00000002, /* EMC_DLI_TRIM_TXDQS2 */
			0x00000002, /* EMC_DLI_TRIM_TXDQS3 */
			0x00000002, /* EMC_DLI_TRIM_TXDQS4 */
			0x00000001, /* EMC_DLI_TRIM_TXDQS5 */
			0x00000003, /* EMC_DLI_TRIM_TXDQS6 */
			0x00000001, /* EMC_DLI_TRIM_TXDQS7 */
			0x00000003, /* EMC_DLI_TRIM_TXDQS8 */
			0x00000003, /* EMC_DLI_TRIM_TXDQS9 */
			0x00000002, /* EMC_DLI_TRIM_TXDQS10 */
			0x00000002, /* EMC_DLI_TRIM_TXDQS11 */
			0x00000002, /* EMC_DLI_TRIM_TXDQS12 */
			0x00000001, /* EMC_DLI_TRIM_TXDQS13 */
			0x00000003, /* EMC_DLI_TRIM_TXDQS14 */
			0x00000001, /* EMC_DLI_TRIM_TXDQS15 */
	...
	{
		0x19,       /* V5.0.16 */
		"1_792000_02_V5.0.16_V1.1", /* DVFS table version */
		...
		31,         /* number of up_down_regs */
		{
			...
			0x00000000, /* EMC_DLL_XFORM_QUSE6 */
			0x00000000, /* EMC_DLL_XFORM_QUSE7 */
			0x0000400d, /* EMC_DLL_XFORM_ADDR0 */
			0x0000400d, /* EMC_DLL_XFORM_ADDR1 */
			0x00000000, /* EMC_DLL_XFORM_ADDR2 */
			0x00004010, /* EMC_DLL_XFORM_ADDR3 */
			0x00004010, /* EMC_DLL_XFORM_ADDR4 */
			0x00000000, /* EMC_DLL_XFORM_ADDR5 */
			...
			0x08080104, /* MC_EMEM_ARB_DA_TURNS */
	...
	{
		0x19,       /* V5.0.16 */
		"1_924000_02_V5.0.16_V1.1", /* DVFS table version */
		...
		31,         /* number of up_down_regs */
		{
			...
			0x00000011, /* EMC_DLL_XFORM_ADDR4 */
			0x00000000, /* EMC_DLL_XFORM_ADDR5 */
			0x00000000, /* EMC_DLL_XFORM_QUSE8 */
			0x00000000, /* EMC_DLL_XFORM_QUSE9 */
			0x00000000, /* EMC_DLL_XFORM_QUSE10 */
