...
static struct tegra12_emc_table loki_ffd_c00_sku0_emc_table[] = {
	{
		0x19,       /* V5.0.16 */
		"06_12750_NoCfgVersion_V5.0.16_V1.1", /* DVFS table version */
		12750,      /* SDRAM frequency */
		800,        /* min voltage */
		800,        /* gpu min voltage */
		"pllp_out0", /* clock source id */
		...
		31,         /* number of up_down_regs */
		{
			...
			0x00000003, /* MC_EMEM_ARB_TIMING_R2W */
			0x00000008, /* MC_EMEM_ARB_TIMING_W2R */
			0x08030203, /* MC_EMEM_ARB_DA_TURNS */
	...
	{
		0x19,       /* V5.0.16 */
		"06_20400_NoCfgVersion_V5.0.16_V1.1", /* DVFS table version */
		20400,      /* SDRAM frequency */
		800,        /* min voltage */
		800,        /* gpu min voltage */
		"pllp_out0", /* clock source id */
	...
	{
		0x19,       /* V5.0.16 */
		"06_40800_NoCfgVersion_V5.0.16_V1.1", /* DVFS table version */
		40800,      /* SDRAM frequency */
		800,        /* min voltage */
		800,        /* gpu min voltage */
		"pllp_out0", /* clock source id */
	...
	{
		0x19,       /* V5.0.16 */
		"06_68000_NoCfgVersion_V5.0.16_V1.1", /* DVFS table version */
		68000,      /* SDRAM frequency */
		800,        /* min voltage */
		800,        /* gpu min voltage */
		"pllp_out0", /* clock source id */
	...
	{
		0x19,       /* V5.0.16 */
		"06_102000_NoCfgVersion_V5.0.16_V1.1", /* DVFS table version */
		102000,     /* SDRAM frequency */
		800,        /* min voltage */
		800,        /* gpu min voltage */
		"pllp_out0", /* clock source id */
	...
	{
		0x19,       /* V5.0.16 */
		"06_204000_NoCfgVersion_V5.0.16_V1.1", /* DVFS table version */
		204000,     /* SDRAM frequency */
		800,        /* min voltage */
		800,        /* gpu min voltage */
		"pllp_out0", /* clock source id */
		...
		31,         /* number of up_down_regs */
		{
			...
			0x00000004, /* MC_EMEM_ARB_TIMING_R2W */
			0x00000008, /* MC_EMEM_ARB_TIMING_W2R */
			0x08040203, /* MC_EMEM_ARB_DA_TURNS */
			0x000a0504, /* MC_EMEM_ARB_DA_COVERS */
			0x72440a05, /* MC_EMEM_ARB_MISC0 */
			0x70000f03, /* MC_EMEM_ARB_MISC1 */
			0x001f0000, /* MC_EMEM_ARB_RING1_THROTTLE */
		},
		{
	...
	{
		0x19,       /* V5.0.16 */
		"06_300000_NoCfgVersion_V5.0.16_V1.1", /* DVFS table version */
		300000,     /* SDRAM frequency */
		820,        /* min voltage */
		820,        /* gpu min voltage */
		"pllc_out0", /* clock source id */
		...
		31,         /* number of up_down_regs */
		{
			...
			0x00020000, /* EMC_ZCAL_INTERVAL */
			0x00000100, /* EMC_ZCAL_WAIT_CNT */
			0x01910010, /* EMC_MRS_WAIT_CNT */
			0x01910010, /* EMC_MRS_WAIT_CNT2 */
			0x00000000, /* EMC_CTT */
			0x00000003, /* EMC_CTT_DURATION */
	...
	{
		0x19,       /* V5.0.16 */
		"06_396000_NoCfgVersion_V5.0.16_V1.1", /* DVFS table version */
		396000,     /* SDRAM frequency */
		850,        /* min voltage */
		850,        /* gpu min voltage */
		"pllm_out0", /* clock source id */
		...
		31,         /* number of up_down_regs */
		{
			...
			0x00020000, /* EMC_ZCAL_INTERVAL */
			0x00000100, /* EMC_ZCAL_WAIT_CNT */
			0x01820010, /* EMC_MRS_WAIT_CNT */
			0x01820010, /* EMC_MRS_WAIT_CNT2 */
			0x00000000, /* EMC_CTT */
			0x00000003, /* EMC_CTT_DURATION */
			0x000052a3, /* EMC_CFG_PIPE */
			0x8000188b, /* EMC_DYN_SELF_REF_CONTROL */
	...
	{
		0x19,       /* V5.0.16 */
		"06_528000_NoCfgVersion_V5.0.16_V1.1", /* DVFS table version */
		528000,     /* SDRAM frequency */
		880,        /* min voltage */
		870,        /* gpu min voltage */
		"pllm_ud",  /* clock source id */
		...
		31,         /* number of up_down_regs */
		{
			...
			0x00020000, /* EMC_ZCAL_INTERVAL */
			0x00000100, /* EMC_ZCAL_WAIT_CNT */
			0x016e0010, /* EMC_MRS_WAIT_CNT */
			0x016e0010, /* EMC_MRS_WAIT_CNT2 */
			0x00000000, /* EMC_CTT */
			0x00000003, /* EMC_CTT_DURATION */
	...
	{
		0x19,       /* V5.0.16 */
		"06_600000_NoCfgVersion_V5.0.16_V1.1", /* DVFS table version */
		600000,     /* SDRAM frequency */
		910,        /* min voltage */
		910,        /* gpu min voltage */
		"pllc_ud",  /* clock source id */
		...
		31,         /* number of up_down_regs */
		{
			...
			0x00020000, /* EMC_ZCAL_INTERVAL */
			0x00000100, /* EMC_ZCAL_WAIT_CNT */
			0x01630010, /* EMC_MRS_WAIT_CNT */
			0x01630010, /* EMC_MRS_WAIT_CNT2 */
			0x00000000, /* EMC_CTT */
			0x00000003, /* EMC_CTT_DURATION */
			0x000040a0, /* EMC_CFG_PIPE */
			0x800024aa, /* EMC_DYN_SELF_REF_CONTROL */
	...
	{
		0x19,       /* V5.0.16 */
		"06_792000_NoCfgVersion_V5.0.16_V1.1", /* DVFS table version */
		792000,     /* SDRAM frequency */
		980,        /* min voltage */
		980,        /* gpu min voltage */
		"pllm_ud",  /* clock source id */
		...
		31,         /* number of up_down_regs */
		{
			...
			0x00020000, /* EMC_ZCAL_INTERVAL */
			0x00000100, /* EMC_ZCAL_WAIT_CNT */
			0x01460010, /* EMC_MRS_WAIT_CNT */
			0x01460010, /* EMC_MRS_WAIT_CNT2 */
			0x00000000, /* EMC_CTT */
			0x00000004, /* EMC_CTT_DURATION */
			0x00004080, /* EMC_CFG_PIPE */
			0x80003012, /* EMC_DYN_SELF_REF_CONTROL */
	...
	{
		0x19,       /* V5.0.16 */
		"06_924000_NoCfgVersion_V5.0.16_V1.1", /* DVFS table version */
		924000,     /* SDRAM frequency */
		1010,       /* min voltage */
		...
		31,         /* number of up_down_regs */
		{
			...
			0x00020000, /* EMC_ZCAL_INTERVAL */
			0x00000128, /* EMC_ZCAL_WAIT_CNT */
			0x01290010, /* EMC_MRS_WAIT_CNT */
			0x01290010, /* EMC_MRS_WAIT_CNT2 */
			0x00000000, /* EMC_CTT */
			0x00000004, /* EMC_CTT_DURATION */
			0x00004080, /* EMC_CFG_PIPE */
			0x800037ea, /* EMC_DYN_SELF_REF_CONTROL */
	...
	{
		0x19,       /* V5.0.16 */
		"06_1056000_NoCfgVersion_V5.0.16_V1.1", /* DVFS table version */
		1056000,    /* SDRAM frequency */
		1100,       /* min voltage */
		1100,       /* gpu min voltage */
		"pllm_ud",  /* clock source id */
		...
		31,         /* number of up_down_regs */
		{
			...
			0x00020000, /* EMC_ZCAL_INTERVAL */
			0x00000152, /* EMC_ZCAL_WAIT_CNT */
			0x010b0010, /* EMC_MRS_WAIT_CNT */
			0x010b0010, /* EMC_MRS_WAIT_CNT2 */
			0x0000000a, /* EMC_CTT */
			0x00000004, /* EMC_CTT_DURATION */
			0x00000000, /* EMC_CFG_PIPE */
			0x80003fc1, /* EMC_DYN_SELF_REF_CONTROL */
	...
	{
		0x19,       /* V5.0.16 */
		"06_1200000_NoCfgVersion_V5.0.16_V1.1", /* DVFS table version */
		1200000,    /* SDRAM frequency */
		1100,       /* min voltage */
		1100,       /* gpu min voltage */
		"pllm_ud",  /* clock source id */
		...
		31,         /* number of up_down_regs */
		{
			...
			0x00000002, /* EMC_PCHG2PDEN */
			0x00000000, /* EMC_ACT2PDEN */
			0x000000b2, /* EMC_AR2PDEN */
			0x0000001f, /* EMC_RW2PDEN */
			0x000000ce, /* EMC_TXSR */
			0x00000200, /* EMC_TXSRDLL */
			0x00000008, /* EMC_TCKE */
			0x00000009, /* EMC_TCKESR */
			...
			0x07070004, /* EMC_XM2VTTGENPADCTRL */
			0x00000000, /* EMC_XM2VTTGENPADCTRL2 */
			0x017fffff, /* EMC_XM2VTTGENPADCTRL3 */
			...
			0x00020000, /* EMC_ZCAL_INTERVAL */
			0x00000180, /* EMC_ZCAL_WAIT_CNT */
			0x00ec0010, /* EMC_MRS_WAIT_CNT */
			0x00ec0010, /* EMC_MRS_WAIT_CNT2 */
			0x0000000a, /* EMC_CTT */
			0x00000004, /* EMC_CTT_DURATION */
			0x00000000, /* EMC_CFG_PIPE */
			0x80004850, /* EMC_DYN_SELF_REF_CONTROL */
			...
			0x00000005, /* MC_EMEM_ARB_TIMING_RAP2PRE */
			0x00000010, /* MC_EMEM_ARB_TIMING_WAP2PRE */
			0x00000002, /* MC_EMEM_ARB_TIMING_R2R */
			0x00000002, /* MC_EMEM_ARB_TIMING_W2W */
			0x00000006, /* MC_EMEM_ARB_TIMING_R2W */
			0x0000000b, /* MC_EMEM_ARB_TIMING_W2R */
			0x0b060202, /* MC_EMEM_ARB_DA_TURNS */
			0x001f141b, /* MC_EMEM_ARB_DA_COVERS */
			0x7212361c, /* MC_EMEM_ARB_MISC0 */
			0x70000f02, /* MC_EMEM_ARB_MISC1 */
			0x001f0000, /* MC_EMEM_ARB_RING1_THROTTLE */
		},
		{
		...
		0x80000125, /* Mode Register 0 */
		0x80100002, /* Mode Register 1 */
		0x80200030, /* Mode Register 2 */
		0x00000000, /* Mode Register 4 */
		1180,       /* expected dvfs latency (ns) */
	},
};

static struct tegra12_emc_table loki_ffd_c00_sku100_emc_table[] = {
	{
		0x19,       /* V5.0.16 */
		"06_12750_NoCfgVersion_V5.0.16_V1.1", /* DVFS table version */
		12750,      /* SDRAM frequency */
...
static struct tegra12_emc_pdata loki_ffd_c00_sku0_emc_pdata = {
	.description = "loki_ffd_c00_sku0_emc_tables",
	.tables = loki_ffd_c00_sku0_emc_table,
	.num_tables = ARRAY_SIZE(loki_ffd_c00_sku0_emc_table),
};

static struct tegra12_emc_pdata loki_ffd_c00_sku100_emc_pdata = {
	.description = "loki_ffd_c00_sku100_emc_tables",
	.tables = loki_ffd_c00_sku100_emc_table,
	.num_tables = ARRAY_SIZE(loki_ffd_c00_sku100_emc_table),
};
...
int __init loki_emc_init(void)
{
	...
	if (of_find_compatible_node(NULL, NULL, "nvidia,tegra12-emc")) {
		...
		if (bi.board_id == BOARD_E2548) {
			...
			default:
				WARN(1,
				    "EMC for this loki sku not supported: %u\n",
				    bi.sku);
				return -EINVAL;
			}
			...
			case BOARD_SKU_FOSTER:
			case BOARD_SKU_0:
				pr_info("Loading Loki FFD C00 sku0 EMC table: 0x%08x\n",
					bi.sku);
				tegra_emc_device.dev.platform_data =
					&loki_ffd_c00_sku0_emc_pdata;
				break;
			case BOARD_SKU_100:
				pr_info("Loading Loki FFD C00 sku100 EMC table: 0x%08x\n",
					bi.sku);
				tegra_emc_device.dev.platform_data =
					&loki_ffd_c00_sku100_emc_pdata;
				break;
			default:
				WARN(1, "EMC for this loki sku not supported: %u\n",
						bi.sku);
