...
static struct tegra12_emc_table mocha_hynix_2gb_derated[] = {
	{
		0x19,       /* V5.0.16 */
		"3_12750_04_V5.0.16_V1.1", /* DVFS table version */
		...
		31,         /* number of up_down_regs */
		{
			...
			0x00090000, /* EMC_DLL_XFORM_DQS4 */
			0x00090000, /* EMC_DLL_XFORM_DQS5 */
			0x00090000, /* EMC_DLL_XFORM_DQS6 */
			0x00090000, /* EMC_DLL_XFORM_DQS7 */
			0x00090000, /* EMC_DLL_XFORM_DQS8 */
			0x00090000, /* EMC_DLL_XFORM_DQS9 */
			0x00090000, /* EMC_DLL_XFORM_DQS10 */
			0x00090000, /* EMC_DLL_XFORM_DQS11 */
			0x00090000, /* EMC_DLL_XFORM_DQS12 */
			0x00090000, /* EMC_DLL_XFORM_DQS13 */
			0x00090000, /* EMC_DLL_XFORM_DQS14 */
			0x00090000, /* EMC_DLL_XFORM_DQS15 */
	...
	{
		0x19,       /* V5.0.16 */
		"3_20400_04_V5.0.16_V1.1", /* DVFS table version */
	...
	{
		0x19,       /* V5.0.16 */
		"3_40800_04_V5.0.16_V1.1", /* DVFS table version */
	...
	{
		0x19,       /* V5.0.16 */
		"3_68000_04_V5.0.16_V1.1", /* DVFS table version */
	...
	{
		0x19,       /* V5.0.16 */
		"3_102000_04_V5.0.16_V1.1", /* DVFS table version */
	...
	{
		0x19,       /* V5.0.16 */
		"3_204000_04_V5.0.16_V1.1", /* DVFS table version */
		...
		31,         /* number of up_down_regs */
		{
			...
			0x00008800, /* EMC_DLL_XFORM_DQ4 */
			0x00008800, /* EMC_DLL_XFORM_DQ5 */
			0x00008800, /* EMC_DLL_XFORM_DQ6 */
			0x00008800, /* EMC_DLL_XFORM_DQ7 */
			0x00000200, /* EMC_XM2CMDPADCTRL */
			0x00000000, /* EMC_XM2CMDPADCTRL4 */
			0x00100100, /* EMC_XM2CMDPADCTRL5 */
			0x0130b018, /* EMC_XM2DQSPADCTRL2 */
			...
			0x000c0707, /* MC_EMEM_ARB_DA_COVERS */
			0x72e40a08, /* MC_EMEM_ARB_MISC0 */
			0x70000f03, /* MC_EMEM_ARB_MISC1 */
			0x001f0000, /* MC_EMEM_ARB_RING1_THROTTLE */
		},
		{
	...
	{
		0x19,       /* V5.0.16 */
		"3_300000_03_V5.0.16_V1.1", /* DVFS table version */
		...
		31,         /* number of up_down_regs */
		{
			...
			0x0000011b, /* EMC_REFRESH */
			0x00000000, /* EMC_BURST_REFRESH_NUM */
			0x00000046, /* EMC_PRE_REFRESH_REQ_CNT */
			0x00000002, /* EMC_PDEX2WR */
			0x00000002, /* EMC_PDEX2RD */
			0x00000005, /* EMC_PCHG2PDEN */
			0x00000000, /* EMC_ACT2PDEN */
	...
	{
		0x19,       /* V5.0.16 */
		"3_396000_03_V5.0.16_V1.1", /* DVFS table version */
	...
	{
		0x19,       /* V5.0.16 */
		"3_528000_03_V5.0.16_V1.1", /* DVFS table version */
		...
		31,         /* number of up_down_regs */
		{
			...
			0x00004010, /* EMC_DLL_XFORM_ADDR1 */
			0x00000000, /* EMC_DLL_XFORM_ADDR2 */
			0x00004010, /* EMC_DLL_XFORM_ADDR3 */
			0x00004010, /* EMC_DLL_XFORM_ADDR4 */
			0x00000000, /* EMC_DLL_XFORM_ADDR5 */
			0x00000000, /* EMC_DLL_XFORM_QUSE8 */
			0x00000000, /* EMC_DLL_XFORM_QUSE9 */
			0x00000000, /* EMC_DLL_XFORM_QUSE10 */
	...
	{
		0x19,       /* V5.0.16 */
		"3_600000_03_V5.0.16_V1.1", /* DVFS table version */
		...
		31,         /* number of up_down_regs */
		{
			...
			0x00000000, /* EMC_DLL_XFORM_QUSE15 */
			0x00000000, /* EMC_DLI_TRIM_TXDQS0 */
			0x00000001, /* EMC_DLI_TRIM_TXDQS1 */
			0x00000000, /* EMC_DLI_TRIM_TXDQS2 */
			0x00000001, /* EMC_DLI_TRIM_TXDQS3 */
			0x00000001, /* EMC_DLI_TRIM_TXDQS4 */
			0x00000000, /* EMC_DLI_TRIM_TXDQS5 */
			0x00000001, /* EMC_DLI_TRIM_TXDQS6 */
			0x00000000, /* EMC_DLI_TRIM_TXDQS7 */
			0x00000000, /* EMC_DLI_TRIM_TXDQS8 */
			0x00000001, /* EMC_DLI_TRIM_TXDQS9 */
			0x00000000, /* EMC_DLI_TRIM_TXDQS10 */
			0x00000001, /* EMC_DLI_TRIM_TXDQS11 */
			0x00000001, /* EMC_DLI_TRIM_TXDQS12 */
			0x00000000, /* EMC_DLI_TRIM_TXDQS13 */
			0x00000001, /* EMC_DLI_TRIM_TXDQS14 */
			0x00000000, /* EMC_DLI_TRIM_TXDQS15 */
			0x0000000c, /* EMC_DLL_XFORM_DQ0 */
		...
		0xa1430000, /* EMC_AUTO_CAL_CONFIG */
		0x00000000, /* Mode Register 0 */
		0x800100e3, /* Mode Register 1 */
		0x80020007, /* Mode Register 2 */
		0x800b0000, /* Mode Register 4 */
		1440,       /* expected dvfs latency (ns) */
	},
	{
		0x19,       /* V5.0.16 */
		"3_792000_03_V5.0.16_V1.1", /* DVFS table version */
		...
		31,         /* number of up_down_regs */
		{
			...
			0x00000000, /* EMC_DLL_XFORM_QUSE6 */
			0x00000000, /* EMC_DLL_XFORM_QUSE7 */
			0x00008012, /* EMC_DLL_XFORM_ADDR0 */
			0x00008012, /* EMC_DLL_XFORM_ADDR1 */
			0x00000000, /* EMC_DLL_XFORM_ADDR2 */
			0x00008012, /* EMC_DLL_XFORM_ADDR3 */
			0x00008012, /* EMC_DLL_XFORM_ADDR4 */
			0x00000000, /* EMC_DLL_XFORM_ADDR5 */
			0x00000000, /* EMC_DLL_XFORM_QUSE8 */
			0x00000000, /* EMC_DLL_XFORM_QUSE9 */
			0x00000000, /* EMC_DLL_XFORM_QUSE10 */
	...
	{
		0x19,       /* V5.0.16 */
		"3_924000_03_V5.0.16_V1.1", /* DVFS table version */
		...
		31,         /* number of up_down_regs */
		{
			...
			0x00000000, /* EMC_DLL_XFORM_ADDR2 */
			0x00000011, /* EMC_DLL_XFORM_ADDR3 */
			0x00000012, /* EMC_DLL_XFORM_ADDR4 */
			0x00000000, /* EMC_DLL_XFORM_ADDR5 */
			0x00000000, /* EMC_DLL_XFORM_QUSE8 */
			0x00000000, /* EMC_DLL_XFORM_QUSE9 */
			0x00000000, /* EMC_DLL_XFORM_QUSE10 */
