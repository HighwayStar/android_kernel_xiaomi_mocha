...
static struct tegra12_emc_table ardbeg_ddr3_emc_table_pm359[] = {
	{
		0x18,       /* V5.0.12 */
		"01_102000_01_V5.0.12_V0.9", /* DVFS table version */
		102000,     /* SDRAM frequency */
		800,        /* min voltage */
		800,        /* gpu min voltage */
		"pllp_out0", /* clock source id */
	...
	{
		0x18,       /* V5.0.12 */
		"01_792000_02_V5.0.12_V0.9", /* DVFS table version */
		792000,     /* SDRAM frequency */
		980,        /* min voltage */
		1100,       /* gpu min voltage */
		"pllm_ud",  /* clock source id */
		...
		31,         /* number of up_down_regs */
		{
			...
			0x00004006, /* EMC_DLL_XFORM_DQS5 */
			0x00004006, /* EMC_DLL_XFORM_DQS6 */
			...
			0x00004006, /* EMC_DLL_XFORM_DQS13 */
			0x00004006, /* EMC_DLL_XFORM_DQS14 */
...
static struct tegra12_emc_table t132_laguna_erss_ddr3_emc_table_pm359[] = {
	{
		0x19,       /* V6.0.0 */
		"01_pre_102000_NoCfgVersion_V6.0.0_V1.1", /* DVFS table version */
		102000,     /* SDRAM frequency */
		800,        /* min voltage */
		800,        /* gpu min voltage */
		"pllp_out0", /* clock source id */
	...
	{
		0x19,       /* V6.0.0 */
		"01_pre_732000_NoCfgVersion_V6.0.0_V1.1", /* DVFS table version */
		...
		31,         /* number of up_down_regs */
		{
			...
			0x00000018, /* EMC_RDV */
			0x0000001a, /* EMC_RDV_MASK */
			0x0000160e, /* EMC_REFRESH */
			0x00000000, /* EMC_BURST_REFRESH_NUM */
			0x00000583, /* EMC_PRE_REFRESH_REQ_CNT */
			0x00000003, /* EMC_PDEX2WR */
			0x00000010, /* EMC_PDEX2RD */
			0x00000001, /* EMC_PCHG2PDEN */
			0x00000000, /* EMC_ACT2PDEN */
			0x000000b8, /* EMC_AR2PDEN */
			0x00000018, /* EMC_RW2PDEN */
			0x000000c7, /* EMC_TXSR */
			0x00000200, /* EMC_TXSRDLL */
			0x00000005, /* EMC_TCKE */
			...
			0x00000008, /* EMC_TCLKSTABLE */
			0x00000008, /* EMC_TCLKSTOP */
			0x0000164e, /* EMC_TREFBW */
			0x00000000, /* EMC_FBIO_CFG6 */
			0x00000000, /* EMC_ODT_WRITE */
			0x00000000, /* EMC_ODT_READ */
			0x104ab098, /* EMC_FBIO_CFG5 */
			0xe00900b1, /* EMC_CFG_DIG_DLL */
			0x00008000, /* EMC_CFG_DIG_DLL_PERIOD */
			...
			0x0000000a, /* EMC_DLL_XFORM_DQS11 */
			0x00000007, /* EMC_DLL_XFORM_DQS12 */
			0x007fc00a, /* EMC_DLL_XFORM_DQS13 */
			0x0000000a, /* EMC_DLL_XFORM_DQS14 */
			0x007fc009, /* EMC_DLL_XFORM_DQS15 */
			0x00000000, /* EMC_DLL_XFORM_QUSE0 */
			0x00000000, /* EMC_DLL_XFORM_QUSE1 */
			0x00000000, /* EMC_DLL_XFORM_QUSE2 */
			0x00000000, /* EMC_DLL_XFORM_QUSE3 */
			...
			0x00000000, /* EMC_XM2VTTGENPADCTRL2 */
			0x016eeeee, /* EMC_XM2VTTGENPADCTRL3 */
			0x51351220, /* EMC_XM2DQSPADCTRL3 */
			0x00511514, /* EMC_XM2DQSPADCTRL4 */
			0x00514514, /* EMC_XM2DQSPADCTRL5 */
			0x4924d200, /* EMC_XM2DQSPADCTRL6 */
			0x0606003f, /* EMC_DSR_VTTGEN_DRV */
			0x00000000, /* EMC_TXDSRVTTGEN */
			0x00000000, /* EMC_FBIO_SPARE */
			0x00020000, /* EMC_ZCAL_INTERVAL */
			0x00000100, /* EMC_ZCAL_WAIT_CNT */
			0x0106000e, /* EMC_MRS_WAIT_CNT */
			0x0106000e, /* EMC_MRS_WAIT_CNT2 */
			0x00000000, /* EMC_CTT */
			0x00000003, /* EMC_CTT_DURATION */
			0x00004080, /* EMC_CFG_PIPE */
			0x80002c81, /* EMC_DYN_SELF_REF_CONTROL */
			0x0000000f, /* EMC_QPOP */
			...
			0x00000008, /* MC_EMEM_ARB_TIMING_W2R */
			0x08060202, /* MC_EMEM_ARB_DA_TURNS */
			0x00160d11, /* MC_EMEM_ARB_DA_COVERS */
			0x736b2112, /* MC_EMEM_ARB_MISC0 */
			0x70000f02, /* MC_EMEM_ARB_MISC1 */
			0x001f0000, /* MC_EMEM_ARB_RING1_THROTTLE */
		},
		{
			0x00000012, /* MC_MLL_MPCORER_PTSA_RATE */
			0x0000015f, /* MC_PTSA_GRANT_DECREMENT */
			0x008b0038, /* MC_LATENCY_ALLOWANCE_XUSB_0 */
			0x008b0038, /* MC_LATENCY_ALLOWANCE_XUSB_1 */
			0x008b003c, /* MC_LATENCY_ALLOWANCE_TSEC_0 */
			0x008b0090, /* MC_LATENCY_ALLOWANCE_SDMMCA_0 */
			0x008b0041, /* MC_LATENCY_ALLOWANCE_SDMMCAA_0 */
			0x008b0090, /* MC_LATENCY_ALLOWANCE_SDMMC_0 */
			0x008b0041, /* MC_LATENCY_ALLOWANCE_SDMMCAB_0 */
			0x00270049, /* MC_LATENCY_ALLOWANCE_PPCS_0 */
			0x008b0080, /* MC_LATENCY_ALLOWANCE_PPCS_1 */
			0x008b0004, /* MC_LATENCY_ALLOWANCE_MPCORE_0 */
			0x008b0004, /* MC_LATENCY_ALLOWANCE_MPCORELP_0 */
			0x00080018, /* MC_LATENCY_ALLOWANCE_HC_0 */
			0x0000008b, /* MC_LATENCY_ALLOWANCE_HC_1 */
			0x008b0004, /* MC_LATENCY_ALLOWANCE_AVPC_0 */
			0x008b001c, /* MC_LATENCY_ALLOWANCE_GPU_0 */
			0x008b0018, /* MC_LATENCY_ALLOWANCE_MSENC_0 */
			0x008b0024, /* MC_LATENCY_ALLOWANCE_HDA_0 */
			0x008b001e, /* MC_LATENCY_ALLOWANCE_VIC_0 */
			0x0000008b, /* MC_LATENCY_ALLOWANCE_VI2_0 */
			0x00000036, /* MC_LATENCY_ALLOWANCE_ISP2_0 */
			0x008b008b, /* MC_LATENCY_ALLOWANCE_ISP2_1 */
			0x00000036, /* MC_LATENCY_ALLOWANCE_ISP2B_0 */
			0x008b008b, /* MC_LATENCY_ALLOWANCE_ISP2B_1 */
			0x00d400ff, /* MC_LATENCY_ALLOWANCE_VDE_0 */
			0x00510029, /* MC_LATENCY_ALLOWANCE_VDE_1 */
			0x008b008b, /* MC_LATENCY_ALLOWANCE_VDE_2 */
			0x008b008b, /* MC_LATENCY_ALLOWANCE_VDE_3 */
			0x008b0065, /* MC_LATENCY_ALLOWANCE_SATA_0 */
			0x008b001e, /* MC_LATENCY_ALLOWANCE_AFI_0 */
		},
		0x00000042, /* EMC_ZCAL_WAIT_CNT after clock change */
		0x001fffff, /* EMC_AUTO_CAL_INTERVAL */
		0x00000802, /* EMC_CTT_TERM_CTRL */
...
static struct tegra12_emc_pdata ardbeg_ddr3_emc_pdata_pm359 = {
	.description = "ardbeg_emc_tables",
#ifndef CONFIG_ARCH_TEGRA_13x_SOC
	.tables = ardbeg_ddr3_emc_table_pm359,
	.num_tables = ARRAY_SIZE(ardbeg_ddr3_emc_table_pm359),
#else
	.tables = t132_laguna_erss_ddr3_emc_table_pm359,
	.num_tables = ARRAY_SIZE(t132_laguna_erss_ddr3_emc_table_pm359),
#endif
};
